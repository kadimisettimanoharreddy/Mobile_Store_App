...
/**
 * Servlet implementation class GooglepayServlet
 */
...
public class GooglepayServlet extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		    ...
		    int gpayotp= (int) ses.getAttribute("googlepayotp");
		 ...
		 try {
			OrderdataFlush.dataflush(request, response, pi, uname,  Integer.parseInt(quantity),totalPrice,"Not Delivered Yet",paymentmethod,Tid,address);
